...
class ControllerConfiguratorProduct extends Controller {
	private $error = array();
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST')/*  && $this->validateForm() */) {
			...
			$this->model_configurator_configurator->addProduct($this->request->post);

			if (isset($this->request->post['is_add_item'])) {
				$this->model_configurator_configurator->addItem($this->request->post);
			}
			...
			$this->response->redirect($this->url->link('configurator/product', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') /* && $this->validateForm() */) {			
			...
			$this->model_configurator_configurator->editProduct($this->request->get['view_id'], $this->request->post);
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) /* && $this->validateDelete() */) {
			...
			foreach ($this->request->post['selected'] as $view_id) {
				$this->model_configurator_configurator->deleteProduct($view_id);
			}
	...
	protected function getForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('configurator/product', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		if (!isset($this->request->get['view_id'])) {
			$data['action'] = $this->url->link('configurator/product/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('configurator/product/edit', 'user_token=' . $this->session->data['user_token'] . '&view_id=' . $this->request->get['view_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('configurator/product', 'user_token=' . $this->session->data['user_token'] . $url, true);

		if (isset($this->request->get['view_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {

			$product_info = $this->model_configurator_configurator->getProduct($this->request->get['view_id']);  
		}

        $materials = $this->model_configurator_configurator->getMaterials();
        $series    = $this->model_configurator_configurator->getSeries();
        $houses    = $this->model_configurator_configurator->getHouses();
        ...
        if (isset($this->request->post['series_id'])) {
			$data['series_id'] = $this->request->post['series_id'];
		} elseif (!empty($product_info)) {
			$data['series_id'] = $product_info['series_id'];
		} else {
			$data['series_id'] = '';
		}
		...
		if (isset($this->request->post['item_image']) && is_file(DIR_IMAGE . $this->request->post['item_image'])) {
			$data['thumb'] = $this->model_tool_image->resize($this->request->post['item_image'], 100, 100);		
		} else {
			$data['thumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}

		if (isset($this->request->post['item_preview']) && is_file(DIR_IMAGE . $this->request->post['item_preview'])) {
			$data['thumb'] = $this->model_tool_image->resize($this->request->post['item_preview'], 100, 100);		
		} else {
			$data['thumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		...
		$this->response->setOutput($this->load->view('configurator/product_form', $data));
	}
    ...
    protected function getList() {
		...
		*/ 
		...
		$data['add'] = $this->url->link('configurator/product/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('configurator/product/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		$products_total = $this->model_configurator_configurator->getTotalProducts();

		$results = $this->model_configurator_configurator->getProducts($filter_data);
		...
		foreach ($results as $result) {				
			...
			$data['views'][] = array(
				...
				'edit'          => $this->url->link('configurator/product/edit', 'user_token=' . $this->session->data['user_token'] . '&view_id=' . $result['view_id'] . $url, true)
			);
		}
		...
		*/ $url = '';
		...
		$pagination->url = $this->url->link('configurator/product', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('configurator/product_list', $data));
	}
    ...
    public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$results = $this->model_configurator_configurator->getProductsForLink($filter_data);
	...
	public function autocompleteForItem() {
		$json = array();
		...
		if (isset($this->request->get['filter_name'])) {
			...
			$results = $this->model_configurator_configurator->getViewsForLink($filter_data);
