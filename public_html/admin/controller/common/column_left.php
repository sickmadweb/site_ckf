...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/offer')) {
				$products[] = array(
					'name'	   => $this->language->get('text_offer'),
					'href'     => $this->url->link('catalog/offer', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}

			if ($this->user->hasPermission('access', 'catalog/view')) {
				$products[] = array(
					'name'	   => $this->language->get('text_view'),
					'href'     => $this->url->link('catalog/view', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
