<?php
class ControllerExtensionFormQueryPrice extends Controller {
	public function index() {
		$this->load->language('extension/form/form');

		$data['title'] = $this->language->get('title_query_price');
		...
		return $this->load->view('extension/form/query_price', $data);
	}
}